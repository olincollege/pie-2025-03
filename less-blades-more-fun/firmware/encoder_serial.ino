...
void sendSerialLog(unsigned long t, float rawAngle, float radAngle,
                   float tIN, float pIN, float rIN, float tOUT)
{
    Serial.print(t);
    Serial.print(", ");
...
//
  ...
  float rawA = as5600.rawAngle();
  float radA = rawA * AS5600_RAW_TO_RADIANS;
