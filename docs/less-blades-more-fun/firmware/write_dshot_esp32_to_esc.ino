...
static constexpr gpio_num_t MOTOR01_PIN = GPIO_NUM_13;
...
//
void loop() {
  motor01.sendThrottlePercent(throttle_percent);
  USB_SERIAL.println(throttle_percent);
  delay(2);
  // Handle serial input
